  ...
  <div class="sales-board">
    ...
    <div class="sales-board-form">
      ...
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <v-selection :selections="tradeListes" @on-change="onParamChange('tradeList', $event)"></v-selection>
        </div>
      </div>
      <div class="sales-board-line">
        <div class="sales-board-line-left">
...
export default {
  ...
  methods: {
    ...
    getPrice () {
      ...
      let reaParams = {
        ...
        tradeLists: this.tradeList,
        versions: buyVersionArray.join(',')
      }
      axios.post('/getPublish', reaParams)
      .then((res) => {
        let data = res.data;
        this.price = data.pubPrice;
      })
      .catch((err) => {
        console.log(err);
      });
  ...
  mounted () {
    this.buyNum = 20;
    this.tradeList = this.tradeListes[0];
    this.version = [this.tradeListes[0]];
    this.getPrice();
  }
}
</script>
